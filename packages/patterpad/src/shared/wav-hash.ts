...
// it runs in both processes. The format: an FNV-1a text hash stored in a LIST/INFO/DINK chunk, so takes
// stamped by any tool that follows it compare equal.
 ...
 *  hash parity requires the same normalisation on the stamping side. */
