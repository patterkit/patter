...
These keys have no menu entry; they're how you write on the page:
...
| `⌘B` / `⌘I` | Bold / italic the selected words (formatting must be on) |
| `/` (empty line) | Open the quick menu to add structure |
