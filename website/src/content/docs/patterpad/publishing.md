...
description: Publish the bundle your game loads, a playable web page to send to anyone, or a readable script for people who would rather read.
sidebar:
  label: Publishing
---
...
want playtesters or collaborators on the latest version, with no engine involved. And if a story
