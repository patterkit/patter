...
// Expr/Mulberry32.h beside this; it is the kernel's, named in `patter` by Kernel.h.
//
...
#include "Patter/Kernel.h"   // the shared PRNG, Expr/Mulberry32.h, and its names in `patter`
